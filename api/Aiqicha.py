...
def run_aiqicha(excel,xlsx_save_name,searchContent):
    selfIcpinfo_infos, invest_infos, holds_infos, branch_infos = start(searchContent)
    saveAiqicha(excel,xlsx_save_name,selfIcpinfo_infos, invest_infos, holds_infos, branch_infos)
...
if __name__ == '__main__':
    searchContent = ""
    #run_aiqicha(excel,xlsx_save_name,searchContent)
