...
def quake_search(all_config,excel,data,xlsx_save_name,domain):
    w_excel=excel.create_sheet("quake",0)
    ...
    for one_data in all_data:
        ...
        try:
            http_host=one_data['service']['http']['host']
        except:
            http_host="null"
        ...
        try:
            body=one_data['service']['http']['body']
        except:
            body="null"
        ...
        try:
            w_excel.append(["quake",ip,port,title,http_host,http_response,cert,transport,asn,org,country_cn,province_cn,city_cn,district_cn,product_catalog,product_type,product_level,product_vendor,hostname,country_en,province_en,city_en,district_en,isp,body])
        except:
            continue
